...
section: pageContent
---
# Codigo de Conduta da Comunidade de desenvolvedores PHP do estado de Pernambuco

> O **PHP Pernambuco** está comprometida a ser uma comunidade livre de discriminação para todos, independente de gênero, identidade e expressão de gênero, orientação sexual, deficiência, aparência física, raça, idade, origem ou religião.
...
Antes de postar ou interagir, LEIA COM ATENÇÃO todas as regras da comunidade #PHPPernambuco.
